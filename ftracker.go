...
func SwimmingSpentCalories(lengthPool, countPool int, duration, weight float64) float64 {
	// ваш код здесь
	meanSeedKmInH := swimmingMeanSpeed(lengthPool, countPool, duration)
	return (meanSeedKmInH + swimmingCaloriesMeanSpeedShift) * swimmingCaloriesWeightMultiplier * weight * duration
}
